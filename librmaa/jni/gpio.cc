...
JNIEXPORT void JNICALL Java_jlibmraa_Gpio_loadGpioNative (JNIEnv *env, jobject thisObj, jint pin, jboolean owner, jboolean raw){
...
JNIEXPORT jint JNICALL Java_jlibmraa_Gpio_dir (JNIEnv *env, jobject thisObj, jobject dir){
  ...
  jclass enumClass = env->FindClass("jlibmraa/Utils$Dir");
