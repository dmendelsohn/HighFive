...
public class DriveTrain{
	...
	*/
    ...
    public void pidDrive(double setPoint, double speed, double currentPosition, double dt, double kp, double ki, double kd){
	leftSpeed = speed;
	rightSpeed = speed;
    ...
    public void setTurnRough(double speed, boolean clockwise){
	if(clockwise){	
		setLeftSpeed(speed);
		setRightSpeed(-speed);
	}else{
