...
public class BoxFollow extends StateBase{
	...
	public BoxFollow(){
		...
		output.drivetrainMethodVals.add(0.0);
		output.drivetrainMethodVals.add(0.4);
		//output.drivetrainMethodVals.add(input.howCentered);
		output.drivetrainMethodVals.add(10.0);
		output.drivetrainMethodVals.add(-1.0/10.0);
